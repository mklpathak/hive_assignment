...
import com.example.android.hive_assignment.databinding.FragmentDetailBinding

/**
 * This [Fragment] shows the offline selected restraunts
...
class DetailFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val restaurant = DetailFragmentArgs.fromBundle(arguments!!).restraunt
